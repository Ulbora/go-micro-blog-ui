...
func TestMCHandler_GetAdminCommentList(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h.GetAdminCommentList(tt.args.w, tt.args.r)
...
func TestMCHandler_ActivateComment(t *testing.T) {
	...
	var mcdel mcd.MockDelegate
	mcdel.MockActivateCommentRes = &mcd.Response{
		Success: true,
	}
	...
	mcdel3.MockActivateCommentRes = &mcd.Response{
		Success: false,
	}
...
func TestMCHandler_DeactivateComment(t *testing.T) {
	...
	var mcdel mcd.MockDelegate
	mcdel.MockDeActivateCommentRes = &mcd.Response{
		Success: true,
	}
	...
	var mcdel3 mcd.MockDelegate
	mcdel3.MockDeActivateCommentRes = &mcd.Response{
		Success: false,
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h.DeactivateComment(tt.args.w, tt.args.r)
			if tt.resCode != tt.w.Code {
				t.Fail()
			}
		})
