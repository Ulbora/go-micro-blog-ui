...
func TestMCHandler_SetAboutPage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h.SetAboutPage(tt.args.w, tt.args.r)
...
func TestMCHandler_SetAbout(t *testing.T) {
	...
	r, _ := http.NewRequest("POST", "/setAbout", strings.NewReader("content=some content"))
	...
	r2, _ := http.NewRequest("POST", "/setAbout", strings.NewReader("id=3&content=some content"))
	...
	r3, _ := http.NewRequest("POST", "/setAbout", strings.NewReader("content=some content"))
	...
	mcdel.MockAddAboutResp = &mcd.ResponseID{
		ID:      3,
		Success: true,
	}
	mcdel.MockUpdateAboutResp = &mcd.Response{
		Success: false,
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h.SetAbout(tt.args.w, tt.args.r)
			if tt.resCode != tt.w.Code {
				t.Fail()
			}
		})
...
func TestMCHandler_GetAbout(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h.GetAbout(tt.args.w, tt.args.r)
			if tt.resCode != tt.w.Code {
				t.Fail()
			}
		})
